...
var ASM_CONSTS = {
  116248: ($0) => { const progress = $0; const elm = document.getElementsByClassName('progress-bar').item(0); if (elm){ const pcg = Math.round(progress * 100); elm.setAttribute('aria-valuenow',pcg); elm.setAttribute('style','width:'+Number(pcg)+'%'); elm.setAttribute('class','progress-bar progress-bar-striped progress-bar-animated'); elm.innerText = Number(pcg)+'%'; } }
};
...
var _encode = Module['_encode'] = createExportWrapper('encode', 5);
